...
2. OMNISCIENT PERSPECTIVE (THE DEATH OF INVESTIGATORS, COURTROOMS, AND CELL TOWER OPERATIONS):
    ...
    - FORENSIC CRIME RECONSTRUCTION (OPTIONAL / CONDITIONAL): A narrative reconstruction of the crime is NOT a universally forced section or timeline phase. Sometimes, stories do not need it depending on the agreed-upon suspense strategy of the case. If the chosen suspense strategy withholds key facts (such as the perpetrator's identity or motive) and requires a detailed, satisfying reveal of how the crime actually took place in hindsight, the plan can gracefully rebuild those timeline events to complete the full story without rushing. Avoid forcing a reconstruction phase if the chronological unfolding of events or the chosen suspense choice does not demand it.
...
- FINAL OUTCOME REGISTER RULE VIOLATION: Flag any usage of legal sentencing jargon in the closing bullets describing resolutions (e.g., prison sentences, permanent incarceration, consecutive tariffs). BANNED words/phrases include: "formally mandated," "minimum tariff," "possibility of parole," "permanent incarceration," "consecutive sentences". Direct that they must describe what actually happened to the person in direct chronological, plainspoken narrative terms.
...
THE FORWARD-ONLY RULE FOR BULLETS: Length must come from chronological depth, never from restatement. Every sentence within a bullet must advance the action to a new moment, introduce a new fact, or reveal a new consequence. If a sentence can be removed without losing any new information — if it only restates, explains, or summarizes what the previous sentence already established — it must be cut. Specifically banned within bullets: (1) Sentences that explain why an action worked or what its purpose was, when that purpose is already obvious from the action itself. (2) Sentences that describe the emotional atmosphere after an event ("the tension in the room was palpable," "this left Mitchell in complete control"). (3) Sentences that restate the logical conclusion of an action that just happened ("this meant the body was now concealed," "this ensured no witnesses were present"). The rule is: event, consequence, next event. No filling the space between them with atmospheric commentary.
...
- CRITICAL DETECTIVE & INVESTIGATIVE ARREST MANDATE (HOW THEY WERE CAUGHT IS REQUIRED): While courtroom/trial scenes and trial/legal jargon are banned, you are strictly forbidden from jumping straight from the crime to the final court resolution/prison sentence. You MUST include detailed chronological events in the final section explaining exactly how the investigators tracked, solved the case, and physically arrested/caught the perpetrators in real-world history. This must be written as real-time omniscient action beats, describing what the investigators physically did to find the clues, follow the suspects, corner them, and carry out the physical arrest (e.g., "The investigators examine the fingerprints...", "Officers track his physical movements to...", "The police corner him and place him under arrest..."). Never skip this phase!
- FORENSIC CRIME RECONSTRUCTION (OPTIONAL / CONDITIONAL): A narrative reconstruction of the crime is NOT a universally forced section or timeline phase. Sometimes, stories do not need it depending on the agreed-upon suspense strategy of the case. If the chosen suspense strategy withholds key facts (such as the perpetrator's identity or motive) and requires a detailed, satisfying reveal of how the crime actually took place in hindsight, the plan can gracefully rebuild those timeline events to complete the full story without rushing. Avoid forcing a reconstruction phase if the chronological unfolding of events or the chosen suspense choice does not demand it.
6.8. LEGAL VOCABULARY BAN IN NARRATIVE BULLETS: Even when no courtroom scene is present, you are forbidden from describing private events using legal/judicial vocabulary. Bullets describing fraud, forgery, estate theft, or financial crime must use plain narrative language. BANNED: "testamentary fraud," "hostile legal takeover," "primary beneficiary," "formally mandated," "disinherits" (as a verb describing a character's action in a bullet). REQUIRED: describe the action — what the character physically did, what document they created, what it said, what financial outcome it produced — in plain spoken language.
6.85. FINAL OUTCOME REGISTER RULE: The closing 1–3 bullets describing the resolution (prison sentence, death, disappearance) must be written in the same plain, natural narrative voice as all other bullets. They are historical facts, not legal summaries or journalistic reports. BANNED in closing bullets: "formally mandated," "minimum tariff," "possibility of parole," "permanent incarceration," "consecutive sentences," and similar judicial or sentencing jargon. REQUIRED: describe the exact final human outcome plainly (e.g., "she is sent to a prison block fifty miles away where she will stay for the rest of her life" rather than "she was given a formally mandated sentence of permanent incarceration with no possibility of parole").
...
2. INVESTIGATIVE DETECTIVE, COURTROOM & CELL-PING LEAKS:
   ...
   - STRICT LEGAL VOCABULARY BAN: Even in off-court private scenes (e.g. will forgery, inheritance dispute, family or financial crimes), you must flag any legal/judicial vocabulary describing these private events. BANNED words/phrases include: "testamentary fraud", "hostile legal takeover", "primary beneficiary", "formally mandated", or "disinherits" (as a verb layout). They must be rewritten back into plain, direct human action statements of what the characters physically did or wrote.
   - FINAL OUTCOME REGISTER RULE: In the closing resolution bullets of the final section (describing prison, death, disappearance), flag any judicial sentencing vocabulary. BANNED words/phrases include: "formally mandated," "minimum tariff," "possibility of parole," "permanent incarceration," "consecutive sentences". Suggest direct, plain spoken chronological outcomes instead (e.g., "he is sent to a prison block for life" rather than "sentenced to permanent incarceration").
