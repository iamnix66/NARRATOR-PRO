...
3. EXHAUSTIVE AND UNCOMPROMISING NARRATIVE COMPLETENESS (NO STORY STRIPPING - 1,500 to 3,000 WORDS OF OUTLINE TEXT PER SECTION REQUIRED): Each section must contain AT LEAST 15 to 30 keys events, and the total word count of the outline points inside a single section MUST BE AT LEAST 1,500 to 3,000 words. We are strictly banning skeleton outlines (e.g., 400-word outlines are completely forbidden as they leave only useless bones). Sincere, meat-packed storytelling is required. Every single chronological development, transaction, agreement, disagreement, meeting, travel, dispute, clue, action, behavior shift, device hidden, and milestone mentioned in the research must be fully mapped and detailed in its own chronological bullet paragraph. You are strictly forbidden from choosing brief, dry, high-level summaries under the excuse of "micro-action bans" or "objective focus." You must include all intermediate events and developments. If a bullet describes an action, make it a robust, story-rich chronological sequence (at least 60 to 120 words per bullet point) so there is genuine substance for the narrative next. Zero story gaps or omissions allowed. If representing 100% of the historical, material details requires 20, 25, or 30+ dense sequential bullets, scale the outline and word count higher dynamically! Never truncate or compress. Your outline must contain ALL of the narrative meat.
4. THE POINT OF DISRUPTION STARTING POINT: Your primary, non-negotiable job is to find and start exactly at the "Point of Disruption" where things first become clear that there is a problem, which serves as the direct catalyst that leads to the climax.
    ...
    - PRESERVE CRUCIAL DETAILS AND BACKGROUND: Do NOT throw away crucial backstories, parental links, relationship dynamics, or motives. Identify them and design how to weave them naturally as quick, parenthetical or direct contextual action lines in later sections as characters act or interact. Do NOT use the disruption point starting rule as a tool to ignore history; just weave those details contextually so no meat is lost.
...
1. LINEAR FLOW FROM THE POINT OF DISRUPTION:
    ...
    - From that point, you should narrate the story in a chronological flow, but flashbacks, non-linear timeline shifts, or temporal leaps are fully permitted when needed or when explicitly requested by the user, and can be used to add dramatic tension or depth. When not needed, stay in a straightforward chronological progression.
2. OMNISCIENT PERSPECTIVE (THE DEATH OF INVESTIGATORS, COURTROOMS, AND CELL TOWER OPERATIONS):
    ...
    - CRITICAL DETECTIVE & INVESTIGATIVE ARREST MANDATE (HOW THEY WERE CAUGHT IS REQUIRED): To prevent an incomplete narrative gap, you are strictly forbidden from jumping straight from the crime to the final court resolution/prison sentence. While courtroom/trial scenes and trial/legal jargon are banned, you MUST include a dedicated chronological phase of detailed events inside the final section explaining exactly how the investigators tracked, solved the case, and arrested/caught the perpetrators in real-world history. This must be written as real-time omniscient action beats, describing what the investigators did to find the clues, follow the suspects, corner them, and carry out the arrest (e.g., "The investigators examine the fingerprints...", "Officers track his movements to...", "The police arrest him..."). Never skip this phase! But you are also strictly forbidden from narrating minor bodily/mechanical micro-actions of the arrest itself (e.g., do NOT write: "the officers went to him, put him on the ground, tied his hands with rope, put him in the back of the patrol car, and took him to the station"). Go straight to the plot point—simply say that the police arrested him and took him to the station, and let the story move forward continuously.
    - FORENSIC CRIME RECONSTRUCTION (OPTIONAL / CONDITIONAL): A narrative reconstruction of the crime is NOT a universally forced section or timeline phase and is STRICKLY OPTIONAL. Never force a reconstruction section. If a narrative reconstruction is used, it must NEVER repeat events, actions, or descriptions (such as the drugging, the shooting, the dismemberment, or the disposal) that have already been narrated or alluded to in previous sections. Repeating acts in different sections of the same outline is a severe redundancy violation. If the story details can be told in a linear, forward-moving chronological order, you must do so rather than introducing a separate reconstruction phase. Avoid reconstruction entirely unless it is critical for suspense, and even then, make sure individual events are told exactly once.
    ...
    - CRITICAL ZERO-MICRO-ACTION RULE: You are STRICTLY FORBIDDEN from narrating minute-by-minute action padding, microscopic bodily movements (e.g. moving a left leg, grabbing a steering wheel, putting a key in ignition, sparking engine, turning a door handle, shifting transmission, or describing the boring physical/mechanical step-by-step detail of handcuffing, tying hands, putting on the ground, and sliding someone into the back of a police car) or trivial numerical specifications (e.g. "forty yards away", "exactly two point four seconds", "at six fourteen p m"). Go straight to the point. Tell the story on a plot-beat level (e.g. "He entered his car and started reversing" or "The police arrested him and sent him to the station"), not second-by-second mechanical fluff. Keep the story moving forward; stop stalling in one place saying the same thing in different ways.
...
3. MULTI-PHASE CHECK & SIMPLICITY AUDIT: 
    ...
    - Each section must be dense enough to hold 15 to 30 detailed actions and chronological developments (minimum of 15 is the strictly enforced MINIMUM floor, not a ceiling. Plan for the full, thick, complete story with 1,500 to 3,000 words *of outline text* in total per section. If there are 15, 20, or 25 sequential developments in progress, you MUST map all of them. Keep the narrative 100% complete with no gaps).
...
4. KEY EVENT PLAN & DENSITY ESTIMATES:
    ...
    - For each section, plan the exact count of key events needed to comprehensively represent the chronological storyline, with at least 15 to 30 keys events planned per section as an absolute, non-negotiable floor limit (aiming for 1,500 to 3,000 words of outline text in total per section). Sincere and complete planning means never rushing to finish the story quickly or compressing events. You must map the full narrative, detail-by-detail, so that no external research or secondary source has information that is missing from your outline. If representing 100% of the historical developments requires 20, 25, or 30+ dense bullets, scale the count higher dynamically! Never truncate or compress meaningful plot developments just to stay close to 15.
...
2. DEEP SYSTEMATIC FORESHADOWING (INCLUDING STAGING, BEHAVIORAL SHIFTS, SITUATIONAL AND CYNICAL LEAKS): Audit the outline for any structural, logical, or phrasing-level spoilers. Flag and correct:
    - STAGING FORESHADOW: Mentioning descriptive details of objects, tools, settings, or vessels (like an "empty suitcase," a "cleared vehicle trunk," or an "unusually heavy rope") when that descriptive nuance only exists to prep the reader for its utility in a future beat. Objects must be described neutrally.
...
3. SAY-IT-ONCE VIOLATIONS: Any detail (forensic evidence, cause of death, personality traits) being established more than once.
...
- EXCEPTION FOR POLICE INVESTIGATION & ARREST (REQUIRED PHASE): Do NOT flag police tracking, finding of clues, and actual arrests as courtroom or trial violations. These real-time investigative tracking and arrest actions (how they were caught) are REQUIRED chronological events and must be present before the final courthouse resolution bullets. Do NOT let the outline skip or jump over how they were caught!
...
- STRICT LEGAL VOCABULARY BAN: Even when no courtroom scene is present, flag any usage of obscure or hyper-technical legal/judicial vocabulary to describe private events (e.g., fraud, forgery, estate theft, or financial crime). BANNED words include hyper-technical jargon like: "testamentary fraud", "hostile legal takeover", "primary beneficiary", "formally mandated", or "disinherits" (as a verb layout). Direct that they must describe the exact actions and outcomes in plain narrative language. However, standard, direct, and common legal, prison, or outcome terms that are familiar to any general reader (e.g., "life imprisonment", "bail", "parole", "jury", "trial", "guilty", "verdict", "convicted", "sentenced to twenty years") are FULLY PERMITTED and must NOT be banned or flagged.
- FINAL OUTCOME REGISTER RULE: The final outcome (verdict or sentence) folded into the last 2-3 bullets of the final section may use standard, familiar crime-lover facts of final justice. Standard, familiar, and direct finality terms (e.g. "sentenced to life imprisonment", "sentenced to thirty years in a state prison", "convicted", "life sentence", "guilty", "sentenced to prison", "parole", "bail", "possibility of parole", "jury") are completely acceptable and MUST NOT be flagged as violations. BANNED phrases are strictly limited to hyper-formal, dry, or pedantic administrative terms (e.g., "formally mandated", "minimum tariff", "permanent incarceration" instead of life imprisonment/prison). Direct that they describe the final human outcome in plain, historical terms.
...
4.7. MICRO-ACTION & MECHANICAL PADDING: Flag any minute-by-minute action sequencing, microscopic bodily movements, bodily/muscle actions or trivial micro-details that have no impact on what happens next.
...
CRITICAL DIRECTIVE: FIDELITY, NARRATIVE MEAT AND DEPTH (NO STORY STRIPPING - 1,500 to 3,000 WORDS PER SECTION REQUIRED)
Reconstruction is NOT summarization. You are forbidden from reducing the volume of information or throwing away events. Every single detail, transaction, meeting, conflict, decision, action, move, plan, and resolution needed to complete the story MUST be included and not omitted. Do not rush to finish quickly.
1. DENSITY MANDATE: True bullet density means a single bullet point MUST group a chronological series of related key events, details, and transitions. Every bullet point is a progression of "what happened" followed immediately by "what happened next."
2. DEPTH & MASSIVE CONTENT PRESERVATION (ABSOLUTELY NO SKELETON OUTLINES - AT LEAST 15 to 30 RICH BULLETS PER SECTION): Every section outline MUST be a detailed document of 1,500 to 3,000 words of outline text. Writing short outline sections (such as 400-word sections) is completely forbidden because it strips all meat from the story, leaving only useless bones. Every single bullet point in the final outline MUST be a rich, multi-sentence chronological paragraph (at least 3-5 sentences long, around 60 to 150 words) describing multiple sequential occurrences in deep chronological sequence. You are strictly forbidden from hiding behind rules like "micro-action bans" or "objective focus" to justify deleting real, intermediate historical events, interactions, disagreements, transactions, or steps from the research. If someone reads your outline, they should have the complete, detailed story with zero omissions. Raise the scale of the bullet count (e.g., 20, 25, 30+ dense bullets per section) where the case's complexity demands it to ensure no information is omitted.
...
The absolute rule is: event, what happened next, what happened next. Every single sentence in a bullet must describe a new active chronological event or action in series.
...
Proper Bullet Density (Grouping a chronological series of sequential related events):
...
5. DETAIL CALIBRATION:
    ...
    - NO REPETITIVE FULL NAMES (USE FIRST NAME & PRONOUNS): If you use a person's full name once to introduce them in the story, you are forbidden from listing their full name repeatedly throughout the narrative. It is unnatural to write full names over and over. Refer to them by their first name only, and use appropriate, flowing pronouns (he/him/she/her) to ensure the narrative is easy, simple, and clean to listen to.
    ...
    - ZERO-MICRO-ACTION RULE & ARREST OVER-DETAIL BAN: BANNED are second-by-second mechanical/bodily descriptions of daily or routine movements (e.g., opening door, sliding onto seat, inserting metal key, sparking engine, shifting transmission lever to reverse, moving a specific leg, or grabbing a steering wheel) and the step-by-step physical/mechanical sequences of an arrest (e.g. putting on the ground, tying hands with rope, placing in the back of the car). Go straight to the plot action (e.g. "He entered his car and reversed" or "The police arrested him and took him to prison" instead of chronicling microscopic bodily moves). If a detail does not affect what happens next, omit it entirely. Stop staying at one place saying the same thing in different ways; make sure the story moves forward continuously!
    ...
    - SENTENCE FLOW, RELATED ACTIONS, AND CONNECTORS (NO CHOPPY SENTENCES): Within each bullet point, you MUST connect sentences that are logically, chronologically, or action-wise related. You are strictly forbidden from writing choppy, staccato, isolated sentences that feel separated and disconnected. Stop being in a hurry to use full stops! Use natural connectors (like "and", "then", "after that", "so", "but then") to join related sequential actions and let the statements flow smoothly. Instead of writing "He went to the bar. He bought some drinks. He finished drinking.", write "He went to the bar and bought some drinks, then he finished drinking and left." Instead of writing "He went into the room. He took the money from the table. He went to the place.", write "He went into the room and took the money from the table, and then after that, he left." For speech disclosures, do not repeat speech attributions like "she said, she said" (e.g., "She told him she went to the house. She said she will come. She said she was late." is BANNED). Connect them: "She told him that she went to the family house and would come later, adding that she would be late for that night." Apply this rule strictly to maintain high quality sentence flow.
...
- CRITICAL DETECTIVE & INVESTIGATIVE ARREST MANDATE (HOW THEY WERE CAUGHT IS REQUIRED): While active courtroom drama is banned, you are strictly forbidden from jumping straight from the crime to the final court resolution/prison sentence. You MUST include detailed chronological events in the final section explaining exactly how the investigators tracked, solved the case, and arrested/caught the perpetrators in real-world history. This must be written as real-time omniscient action beats, describing what the investigators did to find the clues, follow the suspects, corner them, and carry out the arrest. However, do NOT describe the boring mechanical/physical motions of the physical arrest itself (such as putting hands on the ground, tying hands with rope, putting in the back of the car). Go straight to the plot action—simply say that the police arrested him and sent him to prison, and keep the story moving forward!
- FORENSIC CRIME RECONSTRUCTION (OPTIONAL / CONDITIONAL): A narrative reconstruction of the crime is NOT a universally forced section or timeline phase and is STRICTLY OPTIONAL. Never force a reconstruction section. If a narrative reconstruction is used, it must NEVER repeat events, actions, or scene descriptions (such as the drugging, the shooting, the dismemberment, or the disposal) that have already been narrated or alluded to in previous sections. Repeating acts in different sections of the same outline is a severe redundancy violation. If the story details can be told in a linear, forward-moving chronological order, you must do so rather than introducing a separate reconstruction phase. Avoid reconstruction entirely unless it is critical for suspense, and even then, make sure individual events are told exactly once.
6.8. LEGAL VOCABULARY BAN IN NARRATIVE BULLETS: Even when no courtroom scene is present, you are forbidden from describing private events (like wills, deeds, fraud) using hyper-technical legal/judicial vocabulary. Bullets describing fraud, forgery, estate theft, or financial crime must use plain narrative language. BANNED: "testamentary fraud," "hostile legal takeover," "primary beneficiary," "formally mandated." REQUIRED: describe the action — what the character did, what document they created, what it said, what financial outcome it produced — in plain spoken language. Common terms like "life imprisonment", "bail", "parole", "jury", "trial", "guilty", "verdict", "convicted", and "sentenced to prison" are FULLY PERMITTED.
6.85. FINAL OUTCOME REGISTER RULE: The closing 1–3 bullets describing the resolution (prison sentence, death, disappearance) must be written in the same plain, natural narrative voice as all other bullets. Direct, factual, and common finality terms known to all crime stories (e.g. "sentenced to life imprisonment", "sentenced to thirty years in a state prison Block", "convicted", "life sentence", "guilty", "sentenced to prison", "parole", "bail", "possibility of parole", "jury") are completely acceptable and welcome, and MUST NOT be flagged as violations. BANNED phrases are strictly limited to hyper-formal or pedantic administrative terms (e.g., "formally mandated," "minimum tariff," "permanent incarceration" instead of life imprisonment/prison). Describe the exact final human outcome plainly (e.g., "she is sent to a prison block fifty miles away where she will stay for the rest of her life" rather than "she is sentenced to life imprisonment").
...
6.96. BANNED — OVERUSE OF THE WORD "PHYSICAL": Do NOT unnecessarily append or attach the word "physical" or "physically" to items, bodies, locations, actions, or connections unless it specifies a critical legal, forensic, or concrete material division. It adds zero value and sounds repetitive and fake (e.g., use "book" instead of "physical book", "body" instead of "physical body", "going home" instead of "physically going home", "people" instead of "physical people").
6.97. NEW CHARACTER INTRODUCTION RULE: Any character who appears in an outline bullet must either (a) have been established in a prior bullet in any section, or (b) be introduced with one brief identifying phrase in the same bullet where they first appear. One-function characters (characters who appear once to trigger a plot development and are never mentioned again) must be given the minimum human texture to make their appearance feel grounded — not named if they are genuinely anonymous, but not treated as pure plot machinery either.
...
6.6. OBJECTIVE CHRONOLOGICAL ACTION Focus: Skip all clinical numbers, machine weights, or technical jargon. Focus 100% on physical, historical, chronological actions, events, and timeline developments. You are strictly forbidden from including emotional or psychological explanations, character feelings, relationship dynamics, or atmospheric scenic descriptions inside the outline bullets. Furthermore, you are strictly forbidden from including useless specificity about minor elements (such as precise sizes, heights, weights, serial numbers, fence dimensions, or weapon descriptions) of things that don't have a direct impact on the sequence of historical events. If a technical aspect is critical, describe it in a simple one-line action and move on.
...
- NO DISGUISED SINGLE-ACTION BEATS: You are strictly forbidden from writing a single active action (e.g., "He went to the bank") and then padding that bullet with purpose explainers, commentary, or atmosphere. Each bullet must detail a chronological series of sequential events: what happened, and then what happened next (e.g., "He went to the bank, met his accomplice outside, exchanged the money, and drove off").
...
- NO ATMOSPHERIC OR ENVIRONMENTAL FILLERS: Cut sentences that describe the ambient scenery, weather, mood, or context unless those details directly and immediately trigger the next action in the chain.
...
BANNED FORESHADOWING (EXAMPLES):
  ...
  ✘ "He packs a completely empty suitcase for the train ride..." (the descriptive detail of 'empty suitcase' serves no actual or narrative function right now; it only leaks that it will be used to carry stolen cash/goods later. Neutral: "He packs his suitcase.")
...
re-describes forensic evidence — the audience already knows what was found, what it looked like, and
what it proved.
...
all the evidence, cause of death, and character behavior in earlier sections. Then, when writing
...
Can be described in two specific forms. Both are banned:
Form 1 — Evidence restated as testimony.
...
testimony that re-describes forensic evidence, cause of death, character behaviour, or events
...
✘ "A forensic expert described the forensic evidence..." — if the forensic evidence was already
...
2. INVESTIGATIVE DETECTIVE, COURTROOM & CELL-PING LEAKS:
   ...
   - STRICT LEGAL VOCABULARY BAN: Even in off-court private scenes (e.g. will forgery, inheritance dispute, family or financial crimes), you must flag any obscure or hyper-technical legal/judicial vocabulary describing these private events. BANNED words/phrases include hyper-technical jargon like: "testamentary fraud", "hostile legal takeover", "primary beneficiary", "formally mandated". They must be rewritten back into plain, direct human action statements of what the characters actually did or wrote. However, standard, direct, and common legal, prison, or outcome terms familiar to any reader (e.g., "life imprisonment", "bail", "parole", "jury", "trial", "guilty", "verdict", "convicted") are FULLY PERMITTED and must NOT be flagged.
   - FINAL OUTCOME REGISTER RULE: In the closing resolution bullets of the final section (describing prison, death, disappearance), standard familiar direct finality facts (e.g., "sentenced to life imprisonment", "sentenced to prison", "convicted", "found guilty", "parole", "possibility of parole", "bail", "jury") are 100% permitted. Only flag hyper-formal, dry administrative terms. BANNED words/phrases include: "formally mandated", "minimum tariff", "permanent incarceration" instead of life imprisonment/prison sentence. Suggest direct, plain spoken chronological outcomes instead (e.g., "he is sent to a prison block for life" or "sentenced to forty years in a state prison Block" or "given life in prison with the possibility of parole").
